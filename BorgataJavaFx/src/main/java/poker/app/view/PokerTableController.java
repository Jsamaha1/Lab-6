...
public class PokerTableController {
	...
	// Initializes the rule variable, to later be overridden depending on what was selected
	...
	private void handlePlay() {
		...
		// Changes the rle to the respective rule from the hsah set.
	...
	private void handleDraw() {
		// Sets the rule based off of what was selected.
		String strRuleName = mainApp.getRuleName();
		HashMap<String, GameRuleDomainModel> hs = new HashMap();
		hs = GameRuleBLL.getRuleHashSet();		
		GameRuleDomainModel gr = hs.get(strRuleName);
